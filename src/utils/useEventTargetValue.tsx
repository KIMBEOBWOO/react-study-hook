...
export default function useEventTargetValue(defaultValue = ''): {
  ...
  /**
   * @name 전화번호_포매터
   * @param phoneNumber 전화번호, e.target.value <string>
   * @returns xx-xxx-xxxx 혹은 xxx-xxxx-xxxx 꼴의 <string>
   */
  ...
  /**
   * @name 날짜_포매터
   * @param dateString UTC Date String, e.target.value <string>
   * @returns YYYY-MM-DD 꼴의 <string>
   */
